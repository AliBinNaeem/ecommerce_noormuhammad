...
const SideBar: FC<SidebarProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div
      className={`fixed insert-y-0 left-0 z-50 bg-darkColor/50 shadow-xl hoverEffect w-full ${
    ...
    >
      ...
      >
        <div className="flex items-center justify-between">
          <button
            onClick={onClose}
            // https://youtu.be/3hepJA56KF8?t=7469
          >
        ...
        <div className="flex flex-col gap-3.5 text-base font-semibold tracking-wide">
          ...
          {headerData?.map((item) => (
            <Link
              ...
              key={item?.title}
              href={item?.href}
              className={`hover:font-white hoverEffec ${
