  ...
  return (
    <Accordion type="single" collapsible>
      <AccordionItem value="item-1">
        <AccordionTrigger>{product?.name}: Characteristices</AccordionTrigger>
        <AccordionContent className="flex flex-col gap-1">
          ...
          <p className="flex items-center justify-between">
            Stock: <span className="font-semibold tracking-wide">{product?.stock > 0 ? "Available" : "Out of Stock" }</span>
          </p>
          <p className="flex items-center justify-between">
