...
import { getProductBySlug } from "@/sanity/helpers/quieries";
      ...
      <div className="w-full md:w-1/2 flex flex-col gap-5">
        ...
        <div className="flex items-center gap-2.5 lg:gap-5">
          ...
          <button className="border-2 border-darkColor/30 text-darkColor/60 px-2.5 py-1.5 rounded-md hover:text-darkColor hover: border-darkColor hoverEffect">
            ...
            {/* https://youtu.be/3hepJA56KF8?t=20130 */}
          </button>
        </div>
        {/* https://youtu.be/3hepJA56KF8?t=20311 */}
        <ProductCharacteristics product={product} />
        <div
        className="flex flex-wrap items-center justify-between gap-2.5 border-b border-b-gray-200 py-5 -mt-2"
        >
          <div 
        ...
        <div className="flex flex-wrap items-center gap-5">
          <div  className="border border-darkBlue/20 text-center p-3 hover:border-bg-red-700 rounded-md hoverEffect">
            <p
            className="text-base font-semibold text-darkColor"
            >Free Shipping</p>
            <p
            className="text-sm text-gray-500"
            >Free shipping over order $120</p>
          </div>
          <div  className="border border-darkBlue/20 text-center p-3 hover:border-bg-red-700 rounded-md hoverEffect">
            <p
            className="text-base font-semibold text-darkColor"
